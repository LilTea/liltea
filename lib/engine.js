class Engine {
    ...
    element() {
        this.push(this.stack[this.lastArrayIndex()][this.peak()])
    }

    elementPop() {
        let index = this.lastArrayIndex()
        this.push(this.stack[index][this.peak()])
